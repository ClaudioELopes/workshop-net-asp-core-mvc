...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Maria Green", "Maria@gmail.com", new DateTime(1978, 02, 22), 3500.0, d2);
            Seller s3 = new Seller(3, "Alex Grey", "Alex@gmail.com", new DateTime(1992, 11, 02), 2200.0, d1);
            Seller s4 = new Seller(4, "Martha Red", "Martha@gmail.com", new DateTime(1991, 03, 11), 3000.0, d4);
            Seller s5 = new Seller(5, "Donald blue", "Donald@gmail.com", new DateTime(1997, 05, 22), 4000.0, d3);
            Seller s6 = new Seller(6, "Alex Pink", "Pink@gmail.com", new DateTime(1999, 04, 21), 3000.0, d2);
